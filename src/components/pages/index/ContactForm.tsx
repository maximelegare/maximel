      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <BigTitle
            ...
            logo={{ alt: "", imageUrl: "" }}
            styles={{ textAccent: "gradiant-text-green", accent: "gradiant-gray", titlePosition: "default" }}
          ...
          <form
            ...
            className="flex w-full flex-col  gap-5 rounded-md border-2 border-gray-900 bg-black p-6"
          >
